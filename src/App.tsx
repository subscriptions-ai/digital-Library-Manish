        ...
        <AuthProvider>
            <Router>
              ...
              <div className="flex min-h-screen flex-col font-sans text-slate-900 antialiased">
                ...
                <Route path="/institution/journal/:journalId" element={<InstitutionLayout><JournalPage articleBase="/institution/article" /></InstitutionLayout>} />
                <Route path="/institution/author/:authorId" element={<InstitutionLayout><AuthorPage journalBase="/institution/journal" articleBase="/institution/article" /></InstitutionLayout>} />
                <Route path="/institution/article/:articleId" element={<InstitutionLayout><ArticlePage viewerBase="/institution/viewer" journalBase="/institution/journal" authorBase="/institution/author" articleBase="/institution/article" /></InstitutionLayout>} />
                ...
                <>
                  ...
                  <main className="flex-1">
                    <Routes>
                      ...
                      <Route path="/library/journal/:journalId" element={<JournalPage articleBase="/library/article" />} />
                      <Route path="/library/author/:authorId" element={<AuthorPage journalBase="/library/journal" articleBase="/library/article" />} />
                      <Route path="/library/article/:articleId" element={<ArticlePage journalBase="/library/journal" authorBase="/library/author" articleBase="/library/article" />} />
