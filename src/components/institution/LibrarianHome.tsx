...
type DeptRow = { name: string; articles: number; books: number; other: number; total: number };

function Collection({ rows }: { rows: DeptRow[] }) {
        ...
        <section>
          ...
          <div className="mt-3 grid gap-3 lg:grid-cols-2">
            ...
            <div className="rounded-2xl border border-rule bg-surface p-5">
              ...
              <p className="mt-1 text-[12px] text-faint">everything held, by department</p>
              <div className="mt-4">
