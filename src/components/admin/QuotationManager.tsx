        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-5">
              {/* User info */}
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 border-b border-slate-100 pb-4">
                <div>
                ...
                <div>
                  ...
                  <button 
                    onClick={() => setViewEmailTemplate(selected.sentEmailHtml)}
                    disabled={!selected.sentEmailHtml}
                    className="mt-2 text-xs font-bold text-blue-600 hover:text-blue-700 disabled:text-slate-400 disabled:cursor-not-allowed flex items-center gap-1"
                  >
                    <Eye size={12} /> View Sent Email Template
                  </button>
                </div>
              </div>
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/60 p-4 backdrop-blur-md">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl h-[85vh] flex flex-col overflow-hidden border border-slate-700">
            <div className="bg-slate-900 p-4 flex items-center justify-between shrink-0">
              <h3 className="font-bold text-white">Sent Email Template</h3>
              <button onClick={() => setViewEmailTemplate(null)} className="text-slate-400 hover:text-white">
                <X size={20} />
              </button>
            </div>
            <div className="flex-1 bg-slate-100 p-6 overflow-auto">
              <div className="bg-white shadow-md mx-auto max-w-2xl min-h-full border border-slate-200">
                <div dangerouslySetInnerHTML={{ __html: viewEmailTemplate }} />
              </div>
            </div>
          </div>
        </div>
