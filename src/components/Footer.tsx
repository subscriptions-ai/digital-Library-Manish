        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-4 md:grid-cols-2">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><Link to="/legal-disclaimer" className="text-sm hover:text-white transition-colors flex items-center gap-2 group"><span className="w-1.5 h-1.5 rounded-full bg-slate-700 group-hover:bg-blue-500 transition-colors"></span> Legal Disclaimer</Link></li>
              <li><Link to="/content-sources" className="text-sm hover:text-white transition-colors flex items-center gap-2 group"><span className="w-1.5 h-1.5 rounded-full bg-slate-700 group-hover:bg-blue-500 transition-colors"></span> Content Sources</Link></li>
