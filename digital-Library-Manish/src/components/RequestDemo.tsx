...
export function RequestDemo() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      {/* Hero Section */}
      <section className="relative bg-[#0F172A] pt-24 pb-32 lg:pt-32 lg:pb-[400px] text-left overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-start">
            ...
            <div className="lg:col-span-7">
              <motion.div 
                ...
                viewport={{ once: true }}
                className="bg-white rounded-[2.5rem] shadow-2xl border border-slate-100 relative overflow-hidden p-8 md:p-12 -mt-10 lg:-mt-[600px] z-20"
              >
